"""Quote Generation Agent - Main Agent Implementation."""
...
class QuoteGenerationAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self._tool_dispatch = {
            "configure_quote": self.tools.configure_quote,
            "apply_discount": self.tools.apply_discount,
            "generate_document": self.tools.generate_document,
            "manage_expiration": self.tools.manage_expiration,
            "track_conversion": self.tools.track_conversion,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['quote', 'generation', 'analytics', 'automation'],
        )
    ...
    async def process_message(self, request: ChatRequest, user_id: str) -> ChatResponse:
        ...
        rag_results = await self.rag_pipeline.retrieve(
            ...
            top_k=5,
            filters={"user_id": user_id, "domain": "sales"},
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "manage_expiration": ['manage', 'expiration'],
